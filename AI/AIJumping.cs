...
namespace Assets.Scripts.AI
{
	...
	public class AIJumping: AICustomComponentBase {
		...
		if ((jumpStage < maxJumps)) {
				AIPlayerMovement.verticleSpeed = jumpHeight;
				jumpStage++;
				//Debug.Log ("debugging");
		...
		IEnumerator wallJumpCD(){ //this is invoked when the player wall jumps
			...
			AIPlayerMovement.moveVector = new Vector2 (wallJumpx * wallJumpDir * (-1), AIPlayerMovement.verticleSpeed + wallJumpy);
			...
			*/
			...
			AIPlayerMovement.verticleSpeed = wallJumpHeight;
			//PlayerMovement.verticleSpeed = 0f;
